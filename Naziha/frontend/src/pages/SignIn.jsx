...
const SignIn = ({ onLogin }) => { // Add onLogin prop
  ...
  const handleSubmit = async (e) => {
    ...
    if (response.ok) {
      ...
      onLogin(); // Update the authentication status in App.js
        ...
        <form onSubmit={handleSubmit} className="mt-6">
          <div className="mb-4">
            ...
            <input
              type="email"
              id="email"
              className="w-full mt-2 px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-purple-600 focus:outline-none"
          ...
          <button type="submit" className="w-full bg-purple-600 text-white py-2 rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-600">
            Sign in
          </button>
          ...
          <div className="flex justify-center mt-4">
            <button className="bg-white border border-gray-300 text-purple-600 px-4 py-2 rounded-md shadow-sm mr-2 hover:bg-gray-100">
            ...
            <button className="bg-white border border-gray-300 text-purple-600 px-4 py-2 rounded-md shadow-sm hover:bg-gray-100">
          ...
          <div className="text-center text-sm mt-4">
            <span>Don't have an account? <a href="#" className="text-purple-600 hover:text-purple-800">Sign up</a></span>
          </div>
        </form>
      </div>
    </div>
